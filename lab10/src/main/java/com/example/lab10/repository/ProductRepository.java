 ...
 * ✅ เติม method body ให้ครบทุก method เรียบร้อย
 *
...
public class ProductRepository {
    ...
    public ProductRepository() {
        store.put("1", new Product("1", "iPhone 15 Pro (673380431-7 SEC 3)",
    ...
    public Mono<Product> findById(String id) {
        ...
        // หรือจะเขียนแบบสั้นๆ: return Mono.justOrEmpty(store.get(id)); ก็ได้เช่นกัน
    }
